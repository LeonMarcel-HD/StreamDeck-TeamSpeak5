...
image::https://gist.github.com/user-attachments/assets/f81406c5-49a1-4081-95a0-e34866e07274[Image that shows the Start Stream button]
image::https://gist.github.com/user-attachments/assets/23bce3ce-a673-479b-adc8-a8b8de6fd0ad[Image that shows the Overlay button]
image::https://gist.github.com/user-attachments/assets/07d86caf-0dc0-47b7-8147-c270be44c675[Image that shows other features]
