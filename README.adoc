...
<a href="https://marketplace.elgato.com/product/teamspeak-5-871cb93b-a819-48e5-bb06-1aef5e75687f" rel="noopener noreferrer" target="_blank">
    <img src="https://docs.elgato.com/img/badges/get-it-on-marketplace--light.svg" alt="Get it on marketplace" title="Get TeamSpeak 6 on Marketplace" style="height: 60px;"/>
</a>
+++
...
image::https://discourse-forums-images.s3.dualstack.us-east-2.amazonaws.com/optimized/3X/0/d/0d478c353f320eb5e3538d46196c68de3bf600ad_2_345x172.png[Image that shows the Start Stream button]
image::https://discourse-forums-images.s3.dualstack.us-east-2.amazonaws.com/optimized/3X/0/c/0c96515b0dba80fc035505d0717f086be9f89190_2_345x172.png[Image that shows the Overlay button]
image::https://discourse-forums-images.s3.dualstack.us-east-2.amazonaws.com/optimized/3X/3/f/3f4eb6c3e5a54b174de9ae373c9d7d22cb2edfa0_2_345x172.png[Image that shows other features]
